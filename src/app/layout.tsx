  ...
  return (
    <html lang="it" className="scroll-smooth">
      ...
      >
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[9999] focus:px-4 focus:py-2 focus:rounded focus:text-sm focus:font-semibold focus:bg-white focus:text-[var(--accent-copper)] focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-[var(--accent-copper)]"
        >
          Salta al contenuto
        </a>
        <PageLoader />
